...
struct Breed: Codable, Identifiable, Hashable {
    ...
    /// Localized display name (resolved from Localizable.strings)
    var localizedName: String {
        let key = "breed_\(id.replacingOccurrences(of: "-", with: "_"))"
        let localized = String(localized: String.LocalizationValue(key))
        // If localization returns the key itself, fall back to english name
...
struct BreedData {
    ...
    static let dogBreeds: [Breed] = [
        ...
        Breed(id: "dog-bullmastiff", name: "Bullmastiff", species: "dog"),
        Breed(id: "dog-samoyed", name: "Samoyed", species: "dog"),
        Breed(id: "dog-scottish-terrier", name: "Scottish Terrier", species: "dog"),
        Breed(id: "dog-soft-coated-wheaten-terrier", name: "Soft Coated Wheaten Terrier", species: "dog"),
        Breed(id: "dog-airedale-terrier", name: "Airedale Terrier", species: "dog"),
        Breed(id: "dog-jack-russell-terrier", name: "Jack Russell Terrier", species: "dog"),
    ]
    ...
    static let catBreeds: [Breed] = [
        ...
        Breed(id: "cat-burmilla", name: "Burmilla", species: "cat"),
        Breed(id: "cat-colorpoint-shorthair", name: "Colorpoint Shorthair", species: "cat"),
        Breed(id: "cat-javanese", name: "Javanese", species: "cat"),
